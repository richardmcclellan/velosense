...
//    [self performSegueWithIdentifier:@"cellSegue" sender:self];
    GenericDevice *device = [[GenericDevice alloc] initWithPeripheral:[_nb.peripherals objectAtIndex:indexPath.row]];
    DirectionsViewController *dVC = [[DirectionsViewController alloc] initWithDevice:device];
...
- (void) BLEScanButton:(id)sender {
    ...
    [_nb scan_nBlue:3 ServiceFilter:BRServiceBRSP];
}
